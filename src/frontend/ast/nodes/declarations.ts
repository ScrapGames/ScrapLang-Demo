...
export class VariableDecl extends NameableDecl {
  public constructor(
    public isConst: boolean, public type: Undefinedable<TType>, name: string,
    start: Position, end: Position,
  ) {
...
export class VariableDef extends NameableDecl {
  public constructor(
    public isConst: boolean, public type: Undefinedable<TType>, public value: Expression, name: string,
    start: Position, end: Position
  ) {
